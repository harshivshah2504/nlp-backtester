"""Read and write synapse config file
...
synapse_root = os.path.expanduser('~/.synapse')
...
class GlobalConfig(BaseModel):
    ...
    @staticmethod
    def load(config_yaml: str = '~/.synapse/config.yaml'):
    ...
    def save(self, config_yaml: str = '~/.synapse/config.yaml'):
...
if 'pytest' not in sys.modules:
    ...
    assert os.path.exists(os.path.expanduser('~/.synapse/config.pytest.yaml'))
    config = GlobalConfig.load('~/.synapse/config.pytest.yaml')
